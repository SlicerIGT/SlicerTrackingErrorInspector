...
class TrackingErrorMapping(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "TrackingErrorMapping" # TODO make this more human readable by adding spaces
...
class TrackingErrorMappingLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0):
    ...
    if enableScreenshots:
      self.takeScreenshot('TrackingErrorMappingTest-Start','MyScreenshot',-1)
